                            ...
                            <div className='py-5'>
                                <div className='grid grid-cols-2 gap-x-8 mb-5'>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" ref={total_guest} className="mt-1 px-3 py-2 bg-white border border-slate-300 shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="1 Room" />
                                    </div>
                                </div>
                                <div className='grid grid-cols-2 gap-x-8 mb-5'>
                                    <div>
